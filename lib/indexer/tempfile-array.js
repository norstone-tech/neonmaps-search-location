...
class TempFileArray {
	...
	_objToBuf(obj){
		...
		buf.writeUIntLE(obj.lonMin, this._searchNumSize + INT48_SIZE, INT40_SIZE);
		buf.writeUIntLE(obj.latMin, this._searchNumSize + INT48_SIZE + INT40_SIZE, INT40_SIZE);
		buf.writeUIntLE(obj.lonMax, this._searchNumSize + INT48_SIZE + INT40_SIZE * 2, INT40_SIZE);
		buf.writeUIntLE(obj.latMax, this._searchNumSize + INT48_SIZE + INT40_SIZE * 3, INT40_SIZE);
